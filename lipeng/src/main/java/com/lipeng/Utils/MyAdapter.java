...
public class MyAdapter<T> extends RecyclerView.Adapter<MyAdapter.ListHolder> {
    ...
    public MyAdapter(List<T> mData, int layoutId, BindViewInterface bindViewInterface) {
        this.mData = mData;
        this.layoutId = layoutId;
        this.bindViewInterface = bindViewInterface;
    }

    public MyAdapter(int mData, int layoutId, BindViewInterface bindViewInterface) {
    ...
    @Override
    public void onViewAttachedToWindow(MyAdapter.ListHolder holder) {
